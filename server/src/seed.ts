...
export async function seedDatabase() {
  ...
  await prisma.modelConfig.upsert({
    ...
    create: {
      ...
      costCredits4K: 16,
      lowQualityEnabled: true,
      lowQualityCostCredits: 4,
      lowQualityCostCredits2K: 8,
      lowQualityCostCredits4K: 16,
      mediumQualityEnabled: true,
  ...
  await prisma.modelConfig.upsert({
    ...
    create: {
      ...
      costCredits4K: 60,
      lowQualityEnabled: true,
      lowQualityCostCredits: 15,
      lowQualityCostCredits2K: 30,
      lowQualityCostCredits4K: 60,
      mediumQualityEnabled: true,
      highQualityEnabled: false,
      upstreamModel: 'gpt-image-2',
      upstreamProviderId: upstream.id,
